...
function psoOptions = get_psoOptionsHighConditionalElliptic()
psoOptions = struct( ...
    ... %Option FLAGS
    'Flags', struct(...
    ...
    'Vars', struct(...    
    'SwarmSize',   40, ...     %Swarm Size 
    'Iterations',  10000,...    %Maximum Iterations
    'ErrGoal',     1e-10, ...  %Error goal
    'max_gen',      3000,...    % Maximum generations
    'check',           400, ...   
    'stop_num',        50,  ...
    'Dim',         30 ,...   %Dimensions of the problem
     'Threshold',   1e-50), ...  
    ...  %Stratergy Parameters
    'SParams', struct(... 
    'c1',       1.4, ...      %Cognitive Acceleration
    ...
    'Interval',         1,...     %Save after this number of iterations
